...
user1 = User.create([{ email: "peter@meta-review.com", password: "password123", username: "Peter!" }])
user2 = User.create([{ email: "dennis@meta-review.com", password: "password123", username: "dennis" }])
user3 = User.create([{ email: "nick@meta-review.com", password: "password123", username: "NickS" }])
user4 = User.create([{ email: "alex@meta-review.com", password: "password123", username: "ALEX" }])

sites = Site.create([{ title: "Yelp", url: "http://yelp.com", description: "This is a site that reviews restaurants.", user_id: 1  },
...
reviews = Review.create([{ rating: 5, site_id: 1, user_id: 1, body: "This site is great. I always find solid reviews on the restaurant in my area." },
...
comments = Comment.create([{ user_id: 1, review_id: 1, body: "Great review bro" },
